                                                    ...
                                                    <div class="mail-item-heading">
                                                        <div class="mail-item-inner">
                                                            <div class="d-flex">
                                                                ...
                                                                <div class="f-head">
                                                                    <img v-if="item.path" :src="require(`@/assets/${item.path}`)" class="user-profile" alt="avatar" />
                                                                    <div v-else-if="item.first_name" class="avatar avatar-sm">
                                                                        <span class="avatar-title rounded-circle">
                                                                            {{ item.first_name.charAt(0) + '' + item.last_name.charAt(0) }}
                                                                        </span>
                                                                    </div>
                                                                    <img v-else :src="require(`@/assets/user-avtar.svg`)" class="user-profile" alt="avatar" />
                                                                </div>
                                                                <div class="f-body">
                                        ...
                                        <div class="mail-content-container">
                                            <div class="d-flex justify-content-between mb-3">
                                                <div class="d-flex user-info">
                                                    <div class="f-head">
                                                        <img v-if="selected_mail.path" :src="require(`@/assets/${selected_mail.path}`)" class="user-profile" alt="avatar" />
...
useMeta({ title: 'Mailbox' });
    ...
    const bind_mail_list = () => {
      ...
      <div class="gallery text-center">
          <img alt="image-gallery" src="${require('@/assets/scroll-6.jpeg')}" class="img-fluid mb-4 mt-4" style="width: 250px; height: 180px;">
          <img alt="image-gallery" src="${require('@/assets/scroll-7.jpeg')}" class="img-fluid mb-4 mt-4" style="width: 250px; height: 180px;">
          <img alt="image-gallery" src="${require('@/assets/scroll-8.jpeg')}" class="img-fluid mb-4 mt-4" style="width: 250px; height: 180px;">
      </div>
