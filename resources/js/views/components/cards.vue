                    ...
                    <div class="statbox panel box box-shadow">
                        ...
                        <div class="panel-body">
                            <div class="card component-card_2">
                                <img src="@/assets/grid-blog-style-3.jpg" class="card-img-top" alt="widget-card-2" />
                                <div class="card-body">
                    ...
                    <div class="statbox panel box box-shadow">
                        ...
                        <div class="panel-body">
                            <div class="card component-card_3">
                                <div class="card-body">
                                    <img src="@/assets/profile-7.jpeg" class="card-img-top" alt="..." />
                            ...
                            <div class="card component-card_4">
                                <div class="card-body">
                                    <div class="user-profile">
                                        <img src="@/assets/profile-7.jpeg" class="" alt="..." />
                                    </div>
                                    <div class="user-info">
                                        <h5 class="card-user_name">Luke Ivory</h5>
                                        <p class="card-user_occupation">Manager</p>
                                                ...
                                                <div class="col-md-12">
                                                    <ul class="list-inline badge-collapsed-img mb-0 mb-3">
                                                        <li class="list-inline-item chat-online-usr">
                                                            <img alt="avatar" src="@/assets/profile-2.jpeg" class="ms-0" />
                                                        </li>
                                                        <li class="list-inline-item chat-online-usr">
                                                            <img alt="avatar" src="@/assets/profile-3.jpeg" />
                                                        </li>
                                                        <li class="list-inline-item chat-online-usr">
                                                            <img alt="avatar" src="@/assets/profile-4.jpeg" />
                                                        </li>
                                                        <li class="list-inline-item chat-online-usr">
                                                            <img alt="avatar" src="@/assets/profile-5.jpeg" />
                                                        </li>
