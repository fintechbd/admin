                                        ...
                                        <div id="style1" class="carousel slide style-custom-1" data-bs-ride="carousel">
                                            ...
                                            <div class="carousel-inner">
                                                <div class="carousel-item active">
                                                    <img class="d-block w-100 slide-image" src="@/assets/1.jpeg" alt="First slide" />
                                                    <div class="carousel-caption">
                                                        <span class="badge">Lifestyle</span>
                                                        <h3>How To Make More Blog By Doing Less</h3>
                                                        <div class="media">
                                                            <img src="@/assets/profile-6.jpeg" class="" alt="avatar" />
                                                ...
                                                <div class="carousel-item">
                                                    <img class="d-block w-100 slide-image" src="@/assets/3.jpeg" alt="Second slide" />
                                                    <div class="carousel-caption">
                                                        <span class="badge">Lifestyle</span>
                                                ...
                                                <div class="carousel-item">
                                                    <img class="d-block w-100 slide-image" src="@/assets/2.jpg" alt="Third slide" />
                                                    <div class="carousel-caption">
                                                        <span class="badge">Lifestyle</span>
                                ...
                                <div class="col-lg-12">
                                    <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
                                        <div class="carousel-inner">
                                            ...
                                            <div class="carousel-item">
                                                <img class="d-block w-100" src="@/assets/3.jpeg" alt="Third slide" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                                        <div class="carousel-inner">
                                            <div class="carousel-item active">
                                                <img class="d-block w-100" src="@/assets/3.jpeg" alt="First slide" />
                                            </div>
                                            <div class="carousel-item">
                                                <img class="d-block w-100" src="@/assets/2.jpg" alt="Second slide" />
                                            </div>
                                            <div class="carousel-item">
                                                <img class="d-block w-100" src="@/assets/1.jpeg" alt="Third slide" />
                                            </div>
                                        </div>
                                ...
                                <div class="col-sm-12">
                                    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                                        ...
                                        <div class="carousel-inner">
                                            ...
                                            <div class="carousel-item">
                                                <img class="d-block w-100" src="@/assets/1.jpeg" alt="Second slide" />
                                            </div>
                                            <div class="carousel-item">
                                                <img class="d-block w-100" src="@/assets/3.jpeg" alt="Third slide" />
                                            </div>
                                ...
                                <div class="col-lg-12 col-md-12">
                                    <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
                                        ...
                                        <div class="carousel-inner">
                                            ...
                                            <div class="carousel-item">
                                                <img class="d-block w-100" src="@/assets/3.jpeg" alt="Second slide" />
                                                <div class="carousel-caption d-none d-sm-block">
                                                    <h3>Second slide</h3>
                                                    <h5>Lorem ipsum dolor sit amet, dolore magna aliqua.</h5>
                                                </div>
