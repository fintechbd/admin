                        ...
                        <div class="panel-body">
                            <ul class="list-group list-group-media">
                                <li class="list-group-item list-group-item-action">
                                    <div class="media mb-0">
                                        <div class="me-3">
                                            <img alt="avatar" src="@/assets/profile-1.jpeg" class="img-fluid rounded-circle" />
                                        </div>
                                        <div class="media-body">
                                ...
                                <li class="list-group-item list-group-item-action active">
                                    <div class="media mb-0">
                                        <div class="me-3">
                                            <img alt="avatar" src="@/assets/profile-2.jpeg" class="img-fluid rounded-circle" />
                                        </div>
                                        <div class="media-body">
                                ...
                                <li class="list-group-item list-group-item-action">
                                    <div class="media mb-0">
                                        <div class="me-3">
                                            <img alt="avatar" src="@/assets/profile-3.jpeg" class="img-fluid rounded-circle" />
                                        </div>
                                        <div class="media-body">
