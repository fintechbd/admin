            ...
            <div class="row layout-top-spacing">
                <div class="col-12">
                    <div class="alert alert-arrow-left alert-icon-left alert-light-info mb-0 text-break">
                        ...
                        Documentation:
                        <a target="_blank" href="https://getbootstrap.com/docs/5.0/utilities/flex/?#media-object" class="text-info">
                            ...
                            <div class="panel-body">
                                <div class="media">
                                    <div class="media-aside align-self-start">
                                        <img class="rounded" src="@/assets/profile-4.jpeg" alt="pic1" />
                                    </div>
                        ...
                        <div class="statbox panel box box-shadow">
                            ...
                            <div class="panel-body">
                                <ul class="nav list-unstyled">
                                    <li class="media">
                                        <div class="media-aside align-self-start">
                                            <img class="rounded" src="@/assets/profile-3.jpeg" alt="pic1" />
                                        </div>
                                        <div class="media-body">
                                            <h4 class="media-heading">Heading</h4>
                                            <p class="media-text">
                                    ...
                                    <li class="media">
                                        <div class="media-aside align-self-start">
                                            <img class="rounded" src="@/assets/profile-5.jpeg" alt="pic1" />
                                        </div>
                                        <div class="media-body">
                                            <h4 class="media-heading">Heading</h4>
                                            <p class="media-text">
                    ...
                    <div id="mediaObjectNesting" class="col-lg-12 layout-spacing">
                        <div class="statbox panel box box-shadow">
                            ...
                            <div class="panel-body nesting">
                                <div class="media">
                                    <div class="media-aside align-self-start"><img src="@/assets/profile-3.jpeg" alt="pic1" class="meta-usr-img rounded" /></div>
                                    <div class="media-body">
                                        <h4 class="media-heading">Heading</h4>
                                        <p class="media-text">
                                            Sed dapibus nulla elementum, rutrum neque eu, gravida neque. Fusce condimentum cursus mauris et ornare. Mauris fermentum mi id sollicitudin viverra. Aenean
                                        ...
                                        <div class="media mt-4">
                                            <div class="media-aside align-self-start"><img src="@/assets/profile-4.jpeg" alt="pic2" class="rounded" /></div>
                                            <div class="media-body">
                                                <h4 class="media-heading">Heading</h4>
                                                <p class="media-text">
                    ...
                    <div id="mediaObjectNotationText" class="col-lg-12 layout-spacing">
                        <div class="statbox panel box box-shadow">
                            ...
                            <div class="panel-body notation-text">
                                <div class="media">
                                    <div class="media-aside align-self-start"><img src="@/assets/profile-4.jpeg" alt="pic1" class="meta-usr-img rounded" /></div>
                                    <div class="media-body">
                                        <h4 class="media-heading">Heading</h4>
                                        <p class="media-text">
                                            Fusce condimentum cursus mauris et ornare. Mauris fermentum mi id sollicitudin viverra. Aenean dignissim sed ante eget dapibus. Sed dapibus nulla elementum,
