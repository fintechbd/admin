                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="modal-profile mt-4 mb-5">
                                                <img alt="avatar" src="@/assets/profile-2.jpeg" class="rounded-circle" />
                                            </div>
                                            ...
                                            <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                                                ...
                                                <div class="carousel-inner">
                                                    <div class="carousel-item active">
                                                        <img class="d-block w-100" src="@/assets/slider-1.jpeg" alt="First slide" />
                                                    </div>
                                                    <div class="carousel-item">
                                                        <img class="d-block w-100" src="@/assets/slider-2.jpeg" alt="First slide" />
                                                    </div>
                                                    <div class="carousel-item">
                                                        <img class="d-block w-100" src="@/assets/slider-3.jpeg" alt="First slide" />
                                                    </div>
                                                </div>
